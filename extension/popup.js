...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Explain button is always enabled (no input required)
  ...
  function startExplanation() {
    ...
    explainStatusSection.querySelector('.status-text').textContent = 'Starting explain mode...';
    ...
    chrome.runtime.sendMessage({
      ...
      if (response && response.success) {
        explainStatusSection.querySelector('.status-text').textContent = 'Explain mode is active! Click any element in the AWS Console.';
        ...
        explainStatusSection.querySelector('.status-text').textContent = 'Error starting explain mode. Please try again.';
      }
    });
  }
